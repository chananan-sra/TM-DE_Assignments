...
You can start writing assets in `Thinking_Machine_Project/assets.py`. The assets are automatically loaded into the Dagster code location as you define them.
